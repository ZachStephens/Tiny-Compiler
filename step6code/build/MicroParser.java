...
public class MicroParser extends Parser {
	...
	public final Id_listContext id_list() throws RecognitionException {
		...
		try {
			...
			NodeManager.addLocal((((Id_listContext)_localctx).id!=null?_input.getText(((Id_listContext)_localctx).id.start,((Id_listContext)_localctx).id.stop):null),"SAME");
			setState(129);
			id_tail();
			}
		}
	...
	public final Id_tailContext id_tail() throws RecognitionException {
		...
		try {
			...
			case COM_OP:
				...
				NodeManager.addLocal((((Id_tailContext)_localctx).id!=null?_input.getText(((Id_tailContext)_localctx).id.start,((Id_tailContext)_localctx).id.stop):null),"SAME");
				setState(135);
				id_tail();
				}
				break;
