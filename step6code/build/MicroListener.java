...
public interface MicroListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MicroParser#expr_suffix}.
	 * @param ctx the parse tree
	 */
	void enterExpr_suffix(MicroParser.Expr_suffixContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#expr_suffix}.
	 * @param ctx the parse tree
	 */
	void exitExpr_suffix(MicroParser.Expr_suffixContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MicroParser#factor_suffix}.
	 * @param ctx the parse tree
	 */
	void enterFactor_suffix(MicroParser.Factor_suffixContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#factor_suffix}.
	 * @param ctx the parse tree
	 */
	void exitFactor_suffix(MicroParser.Factor_suffixContext ctx);
	/**
